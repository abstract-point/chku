...
#[Fillable(['club_id', 'user_id', 'is_active', 'joined_at', 'gold_owls_count', 'silver_owls_count', 'bronze_owls_count'])]
class ClubMember extends Model
{
    ...
    {
        return $this->belongsToMany(Genre::class, 'club_member_genre');
    }
